...
lab5 <- read.csv("/Users/northlight/Documents/GitHub/Lab5/lab5data.csv")
```
...
# The hypothesis “Greek Women have a lower GPA than non-Greek women” is not supported; the observed p value (0.3886) is greater than .05; there is no significant simple effect.
...
# The hypothesis “On average women have a higher GPA than men” is not supported; the Main Effect “Women vs Men” observed p value (0.7392) is greater than .05, the Simple Effect “Greek Women vs. Greek Men” observed p value (0.2854) is greater than .05, the Simple Effect “non-Greek Women vs. non-Greek Men” observed p (0.5649) is greater than .05; there are no significant main or simple effects.
...
# See below; BOTH 2x2 and 1x4 plots; bars appear the same visually; no obvious visual difference b/c no significant effects.
